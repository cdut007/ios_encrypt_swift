...
public extension Signal {
   ...
   static private func convertUtf8Str(_ text:String)->UnsafePointer<Int8>?{
    ...
    static func encryptMsg(currentUser:String,receiverName:String, orignalMsg:String) -> String{
          // Create key pair
         var keyPair: OpaquePointer? = nil
         var cStr = makeCString(from: orignalMsg)
         SignalProtocol.encryptMsg(convertUtf8Str(currentUser),convertUtf8Str(receiverName),cStr)
